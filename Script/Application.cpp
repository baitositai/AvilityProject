...
const std::string Application::PATH_SOUND = "Resource/Sound/";
const std::string Application::PATH_FONT = "Resource/Font/";
const std::string Application::PATH_TEXT = "Resource/Text/";
const std::string Application::PATH_JSON = "Resource/JSON/";
